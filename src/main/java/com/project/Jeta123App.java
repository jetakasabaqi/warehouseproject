...
@EnableScheduling
public class Jeta123App {

    private static final Logger log = LoggerFactory.getLogger(Jeta123App.class);

    private final Environment env;

    public Jeta123App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jeta123App.class);
